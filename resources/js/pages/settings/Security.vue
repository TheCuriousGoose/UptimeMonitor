...
<template>
    ...
    <h1 class="sr-only">{{ $t('settings.security.breadcrumb') }}</h1>

    <div class="space-y-6">
        <Heading
            variant="small"
            :title="$t('settings.security.password.heading')"
        ...
        >
            ...
            <div class="grid gap-2">
                ...
                <PasswordInput
                    ...
                    :placeholder="$t('settings.security.password.new_label')"
                />
            ...
            <div class="grid gap-2">
                <Label for="password_confirmation">{{
                    $t('settings.security.password.confirmation_label')
                }}</Label>
                <PasswordInput
    ...
    <div v-if="canManageTwoFactor" class="space-y-6">
        <Heading
            variant="small"
            :title="$t('settings.security.two_factor.heading')"
        ...
        >
            <p class="text-sm text-muted-foreground">
                {{ $t('settings.security.two_factor.disabled_hint') }}
            </p>
        ...
        <div v-else class="flex flex-col items-start justify-start space-y-4">
            <p class="text-sm text-muted-foreground">
                {{ $t('settings.security.two_factor.enabled_hint') }}
            </p>
